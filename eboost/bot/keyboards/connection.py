...
# Telegram CopyTextButton limit is 256 bytes. Above that we fall back to a
# callback that sends the link as a separate <code>...</code> message — see
# `copy_link_callback` in the bot router.
